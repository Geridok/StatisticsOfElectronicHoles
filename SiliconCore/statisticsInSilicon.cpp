...
class Silicon {
    private:
        ...
        double h = 1.0f; // 6.62607015e-34
        double k = 1.0f; // 1.380649e-23
    ...
    public:
        Silicon(double E_d, double E_g, double E_c, double m, int N_d0)
        {
            this->E_d = E_d;
            this->E_g = E_g;
            this->E_c = E_c;
        ...
        void calcilate_F_from_T(double T_0, double T_1, double tol = 0.001f, int NT = 1000, int Nn = 1000){
            ...
            while(T < T_1) {
                ...
                double F1_N = 0.5f; // нулевое приближение
...
int main() {
    ...
    */
    ...
    double E_g = 1.0f;
    double E_c = 1.0f;
    double m = 1.0f; // 9.1093837015e-31
    int N_d0 = 100; // static_cast<int>(1e22)
    double T_0 = 10.0f;
    double T_1 = 100.0f;
